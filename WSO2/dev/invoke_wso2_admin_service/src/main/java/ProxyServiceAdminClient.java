...
public class ProxyServiceAdminClient {
     ...
     */
    public String addProxyService(String proxyName,
       ...
       // data.setEnableSecurity(true);
        try {
           return  proxyServiceAdminStub.addProxy(data);
        } catch (Exception e) {
     ...
     * @throws java.rmi.RemoteException remote exception
     */
    public String deleteProxy(String proxyName)
            throws ProxyServiceAdminProxyAdminException, RemoteException {
        return proxyServiceAdminStub.deleteProxyService(proxyName);
    }
